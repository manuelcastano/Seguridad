...
public class Main {
	...
	public static void admin() {
		...
		while(option != 0) {
			...
			System.out.println("3. Poner en blanco la contrase�a de un usuario");
			...
			case 2:
				...
				//Para poner en blanco la contrase�a de un usuario
			case 3:
				try {
	...
	public static void usuario(String nombreUsuario) {
		...
		while(option != 0) {
			...
			System.out.println("2. Cambiar la contrase�a");
			System.out.println("0. Salir");
